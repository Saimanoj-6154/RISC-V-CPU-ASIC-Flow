...
**Current Limitations:**
- No support for RISC-V M-extension (multiply/divide) — integer only (RV32I)
- No exception or interrupt handling
- Single-cycle memory access (no cache — assumes ideal memory)
- Branch predictor is static (not-taken); dynamic prediction not implemented

**Planned Enhancements:**
- [ ] Add RV32M extension (hardware multiplier/divider)
- [ ] Implement a 2-bit saturating counter branch predictor
- [ ] Add a direct-mapped instruction cache (L1-I$)
- [ ] Integrate with a UART peripheral for SoC-level testing
- [ ] Explore porting to a different PDK (e.g., GF180MCU)
- [ ] Add formal verification using SymbiYosys with RISC-V ISA formal spec

---

## References

- [RISC-V ISA Specification (unprivileged)](https://riscv.org/technical/specifications/)
- [SkyWater Sky130 PDK Documentation](https://skywater-pdk.readthedocs.io/)
- [OpenLane RTL-to-GDSII Flow](https://openlane.readthedocs.io/)
...
**Indrakanty Sai Manoj**
Electronics and Communication Engineering
Roorkee Institute of Technology, Roorkee
Expected Graduation: 2027

*Areas of focus: VLSI Design · RTL Verification · FPGA Development · ASIC Physical Design*

---

> *This project is part of an ongoing effort to build production-grade, end-to-end hardware design skills spanning RTL implementation, functional verification, synthesis, and physical design closure.*
